...
## Tests as contract
Tests are our contract - what you promise our software is doing. That's why you are careful to produce behaviour-descriptive, human-readable test output. You structure your tests such that the output of running them is a *test tree*, e.g:
```text
GeneratedComponent
...
*Your test tree is your contract with me.*
...
## Rules
- If you see a test file is missing, in the wrong place, or has the wrong name, fix it immediately:
  - Make sure the test file is actually missing and not just in the wrong place before creating a new on
...
## Tools
`pnpm green-changed` is designed to give you all the feedback you need during testing.
